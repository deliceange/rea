...
//       <Grid container spacing={{ xs: 2, sm: 2 }} sx={{ maxWidth: '1400px', mx: 'auto' }}>
  ...
  return (
    <Box className="page-container">
      ...
      <Grid container spacing={2} sx={{ maxWidth: '1200px', mx: 'auto' }}>
        ...
        <Grid item xs={12} md={6}>
          <Box className="chart-container">
            <Typography variant="h6">Rental Frequency</Typography>
            <ResponsiveContainer width="100%" height={250}>
              <LineChart data={rentalStats.rentalFrequency}>
                <CartesianGrid strokeDasharray="3 3" stroke={colors.grid} />
                <XAxis dataKey="month" stroke={colors.text} />
        ...
        <Grid item xs={12} md={6}>
          <Box className="chart-container">
            <Typography variant="h6">Late Returns</Typography>
            <ResponsiveContainer width="100%" height={250}>
              <BarChart data={rentalStats.lateReturns}>
                <CartesianGrid strokeDasharray="3 3" stroke={colors.grid} />
                <XAxis dataKey="month" stroke={colors.text} />
